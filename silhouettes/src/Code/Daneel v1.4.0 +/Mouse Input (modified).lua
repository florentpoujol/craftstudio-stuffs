                ...
                for i, gameObject in pairs( gameObjects ) do
                    if gameObject.inner ~= nil then
                        ...
                        if gameObject.isMouseOver then
                            ...
                            if leftMouseJustPressed then
                                Daneel.Event.Fire( gameObject, "OnClick", gameObject, raycastHit )

                                if doubleClick then
                                    Daneel.Event.Fire( gameObject, "OnDoubleClick", gameObject, raycastHit )
                                end
                            end
                            ...
                            if rightMouseJustPressed then
                                Daneel.Event.Fire( gameObject, "OnRightClick", gameObject, raycastHit )
                            end
